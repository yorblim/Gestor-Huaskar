    ...
    schemas: {
      ...
      Customer: {
        ...
        properties: {
          id: { type: "string" },
          name: { type: "string" },
          docType: { type: "string", enum: ["dni", "ruc", "ce", "passport"] },
  ...
  paths: {
    ...
    "/api/customers": {
      ...
      post: {
        ...
        security: [{ cookieAuth: [] }, { bearerAuth: [] }],
        requestBody: { required: true, content: { "application/json": { schema: { type: "object", required: ["name"], properties: { name: { type: "string" }, docType: { type: "string", enum: ["dni", "ruc", "ce", "passport"] }, docNumber: { type: "string" }, phone: { type: "string" }, address: { type: "string" } } } } } },
    ...
    "/api/customers/{id}": {
      ...
      put: {
        ...
        security: [{ cookieAuth: [] }, { bearerAuth: [] }],
        parameters: [{ name: "id", in: "path", required: true, schema: { type: "string" } }],
        requestBody: { content: { "application/json": { schema: { type: "object", properties: { name: { type: "string" }, docType: { type: "string", enum: ["dni", "ruc", "ce", "passport"] }, docNumber: { type: "string" }, phone: { type: "string" }, address: { type: "string" } } } } } },
